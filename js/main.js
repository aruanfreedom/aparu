...
var Aparu = {
	shareHover: function() {
		...
		$('#fb').on('click', function() {
			window.open('https://www.facebook.com/sharer.php?s=100&p[title]=Самый%простой%вызов%машины% -%одной%кнопкой!&p[url]=http://taxi.aparu.kz&p[images][0]=http://taxi.aparu.kz/img/logo-big.png', '_blank');
		});
